...
func (c *bookServiceClient) AddBookQuantity(ctx context.Context, in *AddBookQuantityRequest, opts ...grpc.CallOption) (*AddBookQuantityResponse, error) {
	out := new(AddBookQuantityResponse)
	err := c.cc.Invoke(ctx, BookService_AddBookQuantity_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) FinishBookOrder(ctx context.Context, in *FinishBookOrderRequest, opts ...grpc.CallOption) (*FinishBookOrderResponse, error) {
	out := new(FinishBookOrderResponse)
	err := c.cc.Invoke(ctx, BookService_FinishBookOrder_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_AddBookQuantity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddBookQuantityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).AddBookQuantity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_AddBookQuantity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).AddBookQuantity(ctx, req.(*AddBookQuantityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookService_FinishBookOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FinishBookOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).FinishBookOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_FinishBookOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).FinishBookOrder(ctx, req.(*FinishBookOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
